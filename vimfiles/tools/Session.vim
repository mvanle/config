...
set diffexpr=MyDiff()
set guicursor=n-v-c:block-Cursor/lCursor,ve:ver35-Cursor,o:hor50-Cursor,i-ci:ver25-Cursor/lCursor,r-cr:hor20-Cursor/lCursor,sm:block-Cursor-blinkwait175-blinkoff150-blinkon175,n-v-c-i:blinkwait10,n-v-c-i:blinkwait100,n-v-c-i:blinkon0,n-v-c-i:blinkon1,n-v-c-i:blinkwait0,n-v-c-i:blinkw1,n-v-c:blinkwait100,n-v-c:blinkon1,n-v-c:blinkwait2,n-v-c:blinkon0
...
set ruler
set rulerformat=%60(%m%r%(\ (%Y)%)%(%a%)%(\ %h%w%q%)\ %=<%n>\ %-30.(%l(%p%%)/%L,%c%V%)\ %P%)
set selection=exclusive
set selectmode=mouse,key
set sessionoptions=blank,buffers,curdir,folds,help,options,tabpages,winsize,unix,slash,resize
set shiftwidth=4
set shortmess=at
set statusline=%<%f\ %m%r%=%-30(%(\ (%Y)%)%(%a%)\ %h%w%q%)\ %5(<%n>%)\ %-30.(%l(%p%%)/%L,%c%V%)\ %P
set tabstop=4
set viewdir=~/vimfiles/views
set viminfo='100,<50,s10,h,rA:,rB:,c
set whichwrap=b,s,<,>,[,]
set window=57
set nowrapscan
...
set shortmess=aoO
badd +15 vimdir.bat
badd +10 vim_setenv.bat
badd +0 /batch/emacs/emacs_setenv.bat
badd +0 /batch/emacs/emacsdir.bat
args vimdir.bat
...
wincmd w
argglobal
edit /batch/emacs/emacs_setenv.bat
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((10 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
wincmd w
argglobal
edit C:/batch/emacs/emacsdir.bat
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((21 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
